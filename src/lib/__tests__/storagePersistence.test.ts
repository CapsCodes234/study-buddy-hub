...
describe('saveData persistence behavior', () => {
  ...
  it('should preserve empty subjects array when no legacy subjects exist', () => {
    // First, save a state with no subjects
    ...
    // Load and verify subjects array is empty (no legacy to preserve)
    const loaded = loadData();
  ...
  it('should handle missing localStorage gracefully when persistSubjects is false', () => {
    ...
    // Should still save the current state as fallback
  ...
  it('should handle corrupted localStorage gracefully when persistSubjects is false', () => {
    ...
    // Should save the current state as fallback
    saveData(state, { persistSubjects: false });
