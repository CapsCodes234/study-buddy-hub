# Study Buddy Hub — Stage 3 Database ER Model and Field-Level Schema

**Document status:** Draft 2 — database direction approved; migration-ready SQL and RLS specifications pending  
...
| `username` | `text` | No | — | Original display casing |
...
- users may read and update only their profile;
...
| `user_subject_id` | `uuid` | Yes | — | Optional target subject |
...
This schema direction is approved as the field-level database baseline.
